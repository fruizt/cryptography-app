...
const encryptUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/encrypt/substitution";
const decryptUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/decrypt/substitution";
const suggestUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/suggest/substitution";
const analysisAdvUrl =
	"https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/analyse/substitution";
const analysisUrl =
	"https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/analyse/substitution/monograms";
...
const Substitution = () => {
	...
	const analysis = () => {
		if (optionAnalysis === "B") {
			...
			axios.post(analysisAdvUrl, data).then((response) => {
				setanalysisText(response.data.result);
				console.log(response.data.result);
			});
		}
								...
								<form className="p-3 p-xl-4" method="post">
									...
									<div className="mb-3">
										...
										<input
											...
											id="name-1"
											name="Key_encrypt"
											placeholder="Example: ABCDEFGHIJKLMNOPQRSTUVWXYZ (size 26)"
										/>
									</div>
									<div className="mb-3">
