...
const encryptUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/encrypt/affine";
const decryptUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/decrypt/affine";
const suggestUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/suggestKey/affine";
const atackUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/smartAttack/affine";
...
const Affine = () => {
	...
	const atack = () => {
		...
		console.log(data);
		axios.post(atackUrl, data).then((response) => {
						...
						<div className="col-md-6 col-xl-4">
							<div>
								<form className="p-3 p-xl-4">
									...
									<div>
										<div onClick={atack} className="btn btn-primary shadow d-block w-100">
											Try
										</div>
									</div>
									<div>
