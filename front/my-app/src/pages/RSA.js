...
const suggestKeyURL = prod + "/public/suggest/keyrsa";
const encryptTextURL = prod + "/public/encrypt/rsa";
const decryptTextURL = prod + "/public/decrypt/rsa";
...
const RSA = () => {
	...
	const download = (filename) => {
		const text = { privateKey: dKey, p: pKey, q: qKey };
