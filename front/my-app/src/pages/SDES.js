...
const suggestKeyURL="http://localhost:8000/modern/sdes/suggestKey"
const encryptTextURL="http://localhost:8000/modern/sdes/encrypt"
const decryptTextURL="http://localhost:8000/modern/sdes/decrypt"
                ...
                <div className="col-md-6 col-xl-4">
                    <div>
                        <form className="p-3 p-xl-4" >
                            ...
                            <div className="mb-3">
                                <h6 className="fw-bold mb-0">Permutation:</h6><input onChange={addPermutationText} className="form-control" type="text" id="name-1" name="Key_encrypt" placeholder="example: 0,1,1,0 (size 2x2)" value={permutation}/>
                            </div>
                            ...
                            <div onClick={suggestKeyText} className="btn btn-primary shadow d-block w-100" style={{marginBottom:"20px"}}>Suggest key and permutation</div>
