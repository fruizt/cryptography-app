                    ...
                    <div className="collapse navbar-collapse" id="navcol-1">
                        <ul className="navbar-nav mx-auto">
                            ...
                            <li className="nav-item">
                                <div className="nav-item dropdown nav-link active"><a className="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" href="#">classNameic&nbsp;</a>
                            ...
                            <li className="nav-item"></li>
                            <li className="nav-item"><a className="nav-link active" href="shift.html">Github</a></li>
                        </ul>
                    </div>
                </div>
            </nav> */}
