...
const encryptImageURL="http://localhost:8000/modern/tdes/encryptImages"
const decryptImageURL="http://localhost:8000/modern/tdes/decryptImages"
const suggestKeyURL="http://localhost:8000/modern/generateKeyBits"
const encryptTextURL="http://localhost:8000/modern/tdes/encrypt"
const decryptTextURL="http://localhost:8000/modern/tdes/decrypt"
    ...
    <section className="py-5">
        <div className="container py-5">
            ...
            <div className="row d-flex justify-content-center">
                ...
                <div className="mb-3">
                    <h6 className="fw-bold mb-0">Key:</h6><input onChange={addKey2} className="form-control" type="text" id="name-1" name="Key_encrypt" placeholder="example: 0,1,1,0 (size 2x2)" value={keyVal2}/>
                </div>
                <div className="mb-3">
                                <h6  className="fw-bold mb-0">Size Key:</h6><select onChange={addSizeKey} className="form-select" name="option_encrypt">
                                    <option value="12" selected="">16</option>
                                    <option value="16">24</option>
                                    
                                </select>
                            </div>
                <div onClick={addSuggestKey} className="btn btn-primary shadow d-block w-100" style={{marginBottom:"20px"}}>Suggest key</div>
                <h6 className="fw-bold mb-0">Option:</h6>
                <select  onChange={addOption} className="form-select" style={{marginBottom:"20px"}} name="option_encrypt">
                    <option value="E" selected="">Encrypt</option>
                    <option value="D">Decrypt</option>
                </select>

                <h6 className="fw-bold mb-0">Mode of operation:</h6>
                <select  onChange={addOptionMode} className="form-select" style={{marginBottom:"20px"}} name="option_encrypt">
                    <option value="1" selected="">Electronic Code Book (ECB)</option>
                    <option value="2">Cipher-Block Chaining (CBC)</option>
                    <option value="3" selected="">Cipher FeedBack (CFB)</option>
                    <option value="5" selected="">Output FeedBack (OFB)</option>
                    <option value="6" selected="">CounTer Mode (CTR)</option>
                </select>
                ...
                <div className="col-md-6 col-xl-4">
                    <div>
                        ...
                        <form className="p-3 p-xl-4" >
                            ...
                            <div className="mb-3">
                                <div><div onClick={copyImage} className="btn btn-primary shadow d-block w-100" >{"<- Copy"}</div></div>
            ...
            <div className="row mb-5" style= {{marginTop: "48px"}}>
                <div className="col-md-8 col-xl-6 text-center mx-auto">
                    <p className="fw-bold text-success mb-2" style={{fontSize: "25px"}}>T-DES-text</p>
                </div>
            </div>
            <div className="row d-flex justify-content-center">
                <div className="col-md-6 col-xl-4">
                    <div>
                        <form className="p-3 p-xl-4" >
                            <div className="mb-3">
                                <h6 className="fw-bold mb-0">Text:</h6><textarea onChange={addInputText} className="form-control" id="message-1" name="message" rows="6" placeholder="Message" style={{height: "200px"}} value={clearTextText}></textarea>
                            </div>
                            <div className="mb-3">
                            <div className="mb-3">
                            <h6 className="fw-bold mb-0">Key:</h6><input onChange={addKeyText} className="form-control" type="text" id="name-1" name="Key_encrypt" placeholder="example: 0,1,1,0 (size 2x2)" value={keyValueText}/>
                            </div>
                            <div className="mb-3">
                            ...
                            <div onClick={suggestKeyText} className="btn btn-primary shadow d-block w-100" style={{marginBottom:"20px"}}>Suggest key</div>
                            <h6 className="fw-bold mb-0">Option:</h6>
                            <select  onChange={addOptionText} className="form-select" style={{marginBottom:"20px"}} name="option_encrypt">
                                <option value="E" selected="">Encrypt</option>
                                <option value="D">Decrypt</option>
                            </select>
                            </div>
                            ...
                            <div>
                                ...
                                <div><input onChange={addIV} value={iv} className="form-control" type="text" id="name-3" name="Key_encrypt" style={{marginBottom:"20px"}}/></div>
                            </div>
                            
                            }
                    
                            <h6 className="fw-bold mb-0">Mode of operation:</h6>
                            <select  onChange={addOptionModeText} className="form-select" style={{marginBottom:"20px"}} name="option_encrypt">
                                <option value="1" selected="">Electronic Code Book (ECB)</option>
                                <option value="2">Cipher-Block Chaining (CBC)</option>
                                <option value="3" selected="">Cipher FeedBack (CFB)</option>
                                <option value="5" selected="">Output FeedBack (OFB)</option>
                ...
                <div className="col-md-6 col-xl-4">
                    <div>
                        <form className="p-3 p-xl-4" >
                            ...
                            <div className="mb-3">
                                <h6 className="fw-bold mb-0">Initialization vector:</h6>
                                <div><input value={ivCopy} className="form-control" type="text" id="name-3" name="Key_encrypt" readOnly=""/></div>
