                    ...
                    <div className="col mb-5">
                        <div className="card shadow-sm">
                            <div className="card-body px-4 py-5 px-md-5">
                                ...
                                <p className="text-muted card-text mb-4">The encryption step performed by a Caesar cipher is often incorporated as part of more complex schemes, such as the Vigenère cipher, and still has modern application in the ROT13 system.</p><NavLink className="btn btn-primary shadow" to="/sdes">Try</NavLink>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col mb-4">
                        <div className="card shadow-sm">
                            <div className="card-body px-4 py-5 px-md-5">
                                ...
                                <p className="text-muted card-text mb-4">The affine cipher is a type of monoalphabetic substitution cipher, where each letter in an alphabet is mapped to its numeric equivalent, encrypted using a simple mathematical function, and converted back to a letter.</p><NavLink className="btn btn-primary shadow" to="/tdes">Try</NavLink>
                            </div>
                        </div>
                    </div>
                    <div className="col mb-4">
                        <div className="card shadow-sm">
                            <div className="card-body px-4 py-5 px-md-5">
                                ...
                                <p className="text-muted card-text mb-4">First described by Giovan Battista Bellaso in 1553, the cipher is easy to understand and implement, but it resisted all attempts to break it until 1863, three centuries later.</p><NavLink className="btn btn-primary shadow" to="/aes">Try</NavLink>
                            </div>
                        </div>
                    </div>
