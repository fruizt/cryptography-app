...
import SignRSA from "./pages/SignRSA";
  ...
  return (
      <div>
        ...
        <div className="container"><NavLink className="navbar-brand d-flex align-items-center" to="/"><span className="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-bezier">
                    ...
                    </svg></span><span>Secrypt</span></NavLink><button data-bs-toggle="collapse" className="navbar-toggler" data-bs-target="#navcol-1"><span className="visually-hidden">Toggle navigation</span><span className="navbar-toggler-icon"></span></button>
            <div className="collapse navbar-collapse" id="navcol-1">
                <ul className="navbar-nav mx-auto">
                    <li className="nav-item"><NavLink className="nav-link" to="/">Home</NavLink></li>
                    <li className="nav-item">
                        <div className="nav-item dropdown nav-link active"><NavLink className="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" to="/">Classic Methods&nbsp;</NavLink>
                    ...
                    <li className="nav-item">
                        <div className="nav-item dropdown nav-link active"><NavLink className="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" to="/">Signatures&nbsp;</NavLink>
                            <div className="dropdown-menu dropdown-menu-dark"><NavLink className="dropdown-item" to="/dss">DSS</NavLink><NavLink className="dropdown-item" to="/signrsa">RSA</NavLink></div>
                        </div>
                    </li>
      ...
      <Routes>
          ...
          <Route path="/signrsa" element={<SignRSA />} />
      ...
      <footer className="bg-dark">
        <div className="container py-4 py-lg-5">
            ...
            <div className="text-muted d-flex justify-content-between align-items-center pt-3">
                <p className="mb-0">Copyright © 2022 Secrypt</p>
