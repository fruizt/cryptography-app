...
const encryptImageURL =
	"https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/encrypt/hillimage";
const decryptImageURL =
	"https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/decrypt/hillimage";
const suggestUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/suggest/hill";
const showUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/showImage";

const encryptTextURL = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/encrypt/hilltext";
const decryptTextURL = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/decrypt/hilltext";
const suggestTextUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/suggest/hill";

const attackTextUrl = "https://quickstart-image-b6b23rgmpa-uc.a.run.app/classic/analyse/hilltext";
...
const Hill = () => {
	...
	const makeAttack = () => {
		...
		console.log(data);
		axios.post(attackTextUrl, data).then((response) => {
	...
	const suggestText = () => {
		...
		console.log(data);
		axios.post(suggestTextUrl, data).then((response) => {
						...
						<div className="col-md-6 col-xl-4">
							<div>
								<form className="p-3 p-xl-4">
									...
									<div className="mb-3">
										<h6 className="fw-bold mb-0">Option:</h6>
										<select onChange={addOptionText} className="form-select" name="option_encrypt">
											<option value="E" selected="">
												Encrypt
											</option>
											<option value="D">Decrypt</option>
						...
						<div className="col-md-6 col-xl-4">
							<div>
								<form className="p-3 p-xl-4">
									...
									<div className="mb-3">
										<div>
											<div onClick={suggestText} className="btn btn-primary shadow d-block w-100">
												Suggest Key
											</div>
										</div>
										<div>
											<input
												value={suggestKeyText}
												className="form-control"
												type="text"
												id="name-3"
												name="Key_encrypt"
					...
					<div className="row d-flex justify-content-center">
						<div className="col-md-6 col-xl-4">
							<div>
								<form className="p-3 p-xl-4">
									<div className="mb-3">
										<h6 className="fw-bold mb-0">Clear Text:</h6>
										<input
											onChange={addClearText}
											className="form-control"
											type="text"
											id="name-1"
											name="Key_encrypt"
									...
									<div className="mb-3">
										<h6 className="fw-bold mb-0">Encrypt Text:</h6>
										<input
											onChange={addEncryptText}
											className="form-control"
											type="text"
											id="name-1"
											name="Key_encrypt"
									...
									<div className="mb-3">
										<h6 className="fw-bold mb-0">Size Key:</h6>
										<select onChange={addSizeAttack} className="form-select" name="option_encrypt">
											<option value="2" selected="">
												2
											</option>
											<option value="3">3</option>
									...
									<div className="mb-3"></div>
									<div>
										<div onClick={makeAttack} className="btn btn-primary shadow d-block w-100">
											Try{" "}
										</div>
									</div>
								</form>
						...
						<div className="col-md-6 col-xl-4">
							<div>
								<form className="p-3 p-xl-4">
									<div className="mb-3">
										<h6 className="fw-bold mb-0">Key result:</h6>
										<textarea
											value={finalKey}
											className="form-control"
											id="message-3"
